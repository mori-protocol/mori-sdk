...
import './MoriV3Pool.sol';

contract MoriV3PoolDeployer is IMoriV3PoolDeployer {
    struct Parameters {
        address factory;
        address token0;
        address token1;
    ...
    /// @inheritdoc IMoriV3PoolDeployer
    ...
    /// @param factory The contract address of the MoriSwap V3 factory
    ...
    function deploy(
        ...
        pool = address(new MoriV3Pool{salt: keccak256(abi.encode(token0, token1, fee))}());
        delete parameters;
    }
}
