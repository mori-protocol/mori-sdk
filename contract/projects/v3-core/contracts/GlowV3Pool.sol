...
import './interfaces/IMoriV3PoolDeployer.sol';
import './interfaces/IMoriV3Factory.sol';
...
import '@moriswap/v3-lm-pool/contracts/interfaces/IMoriV3LmPool.sol';

contract MoriV3Pool is IMoriV3Pool {
    ...
    /// @inheritdoc IMoriV3PoolImmutables
    ...
    modifier onlyFactoryOrFactoryOwner() {
        require(msg.sender == factory || msg.sender == IMoriV3Factory(factory).owner());
        _;
    }

    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = IMoriV3PoolDeployer(msg.sender).parameters();
    ...
    /// @inheritdoc IMoriV3PoolDerivedState
    ...
    function mint(
        ...
        IMoriV3MintCallback(msg.sender).moriV3MintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            IMoriV3SwapCallback(msg.sender).moriV3SwapCallback(amount0, amount1, data);
    ...
    function flash(address recipient, uint256 amount0, uint256 amount1, bytes calldata data) external override lock {
        ...
        IMoriV3FlashCallback(msg.sender).moriV3FlashCallback(fee0, fee1, data);
    ...
    /// @inheritdoc IMoriV3PoolOwnerActions
