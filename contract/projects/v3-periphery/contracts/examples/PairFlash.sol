...
import '@moriswap/v3-core/contracts/interfaces/callback/IMoriV3FlashCallback.sol';
...
/// @notice An example contract using the moriswap V3 flash function
contract PairFlash is IMoriV3FlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `MoriV3FlashCallback`
    function initFlash(FlashParams memory params) external {
        ...
        IMoriV3Pool pool = IMoriV3Pool(PoolAddress.computeAddress(deployer, poolKey));
