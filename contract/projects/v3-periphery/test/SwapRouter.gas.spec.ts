import { abi as IMoriV3PoolABI } from '@moriswap/v3-core/artifacts/contracts/interfaces/IMoriV3Pool.sol/IMoriV3Pool.json'
import { Fixture } from 'ethereum-waffle'
import { BigNumber, constants, ContractTransaction, Wallet } from 'ethers'
import { ethers, waffle } from 'hardhat'
import { IMoriV3Pool, IWETH9, MockTimeSwapRouter, TestERC20 } from '../typechain-types'
...
describe('SwapRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    pools: [IMoriV3Pool, IMoriV3Pool, IMoriV3Pool]
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, IMoriV3PoolABI, wallet)) as [
      IMoriV3Pool,
      IMoriV3Pool,
      IMoriV3Pool
    ]
  ...
  let pools: [IMoriV3Pool, IMoriV3Pool, IMoriV3Pool]
  ...
  describe('#exactInput', () => {
    ...
    it.skip('0 -> 1 minimal', async () => {
      const calleeFactory = await ethers.getContractFactory('TestMoriV3Callee')
