...
import { Rounding, type BigintIsh } from '../constants/internalConstant'
import type { Token } from "src/constants";


export class Price<TBase extends Token, TQuote extends Token> extends Fraction {
    public readonly baseToken: TBase // input i.e. denominator

    public readonly quoteToken: TQuote // output i.e. numerator
  ...
  */
    public constructor(
        ...
        this.baseToken = baseCurrency
        this.quoteToken = quoteCurrency
   ...
   */
    public multiply<TOtherQuote extends Token>(other: Price<TQuote, TOtherQuote>): Price<TBase, TOtherQuote> {
        invariant(this.quoteToken.equals(other.baseToken), 'TOKEN')
...
*/
    public quote(currencyAmount: CurrencyAmount<TBase>): CurrencyAmount<TQuote> {
        invariant(currencyAmount.currency.equals(this.baseToken), 'TOKEN')
        const result = super.multiply(currencyAmount)
        return CurrencyAmount.fromFractionalAmount(this.quoteToken, result.numerator, result.denominator)
    }
