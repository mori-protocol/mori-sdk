...
import { Rounding, MaxUint256, type Token, type BigintIsh } from '../constants'
...
export class CurrencyAmount<T extends Token> extends Fraction {
     ...
     */
    public static fromRawAmount<T extends Token>(currency: T, rawAmount: BigintIsh): CurrencyAmount<T> {
